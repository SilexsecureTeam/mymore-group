            ...
            <section className="w-full">
                ...
                <div className="flex flex-col md:flex-row">
                    <div className="md:w-1/2">
                        <img src={travelImg} alt="Why Work With Us" className="w-full h-full object-cover" />
                    </div>
                        ...
                        <div className="flex items-center mb-10 space-x-2">
                            {Array.from({ length: pageCount }).map((_, p) => (
                                <button
                                    ...
                                    className={`w-6 h-2 rounded-full transition-colors ${p === whyIndex ? 'bg-white' : 'bg-white/50'
                                        }`}
                                />
                            ))}
                        </div>
                    ...
                    <div className="flex items-center mb-10 space-x-2">
                        {openings.map((_, idx) => (
                            <button
                                ...
                                className={`w-6 h-2 rounded-full transition-colors ${idx === openIndex ? 'bg-red-600' : 'bg-white/50'
                                    }`}
                            />
                        ))}
                    </div>
            ...
            <section className="bg-table text-white">
                ...
                <div className="w-full bg-[rgb(0,0,0,0.5)] h-fit md:h-[400px] py-16 mx-auto px-6 md:px-24 mb-12 flex flex-col lg:flex-row items-center">
                    <div className="lg:w-1/3 text-white !space-y-4">
                        ...
                        You don’t just work here you
                        build moments, memories, and meaningful impact.
                        </p>
                    </div>
                </div>
                {/* Grid of hotel cards */}
