    ...
    <footer className="text-white">
      ...
      <div className="px-6 md:px-24 py-12">
        ...
        <form className="flex max-w-3xl relative -mb-22">
          ...
          <button
            type="submit"
            className=" absolute right-4 top-0 bottom-0 h-max my-auto p-2 md:px-20 md:py-4 bg-[#383737] text-white font-medium rounded-[6px] hover:bg-gray-700 transition"
          >
            <span className="hidden sm:inline">Subscribe</span>
            <FaSearch className="inline sm:hidden text-xl" />
          </button>
        </form>
      </div>
      ...
      <div className="bg-[#383737] px-6 md:px-24 py-16 w-full flex flex-col md:flex-row md:justify-between">
        ...
        <div className="mb-8 md:mb-0 md:w-1/3">
          <img src={logo} alt="Mymore Travels Logo" className="-ml-7 mb-4" />
        ...
        <div className="flex flex-row space-x-16 md:space-x-20 md:w-1/3 text-white !font-bold">
          <div className="mb-8 sm:mb-0">
            ...
            <ul className="!space-y-2 text-[#ffffff]text-sm font-bold">
              <li>
                <a href="/career" className="hover:text-white !font-bold">
                  Careers
                </a>
              </li>
              <li>
      ...
      <div
        className="px-6 md:px-12 py-10 bg-[#383737]  border-t-3 border-white"
        style={{
          borderImageSource:
            "linear-gradient(to left, rgba(102, 102, 102, 0.05), #FFFFFF, rgba(102, 102, 102, 0.05))",
